...
public class SettingsFragment extends PreferenceFragmentCompat {
	...
	private SwitchPreference prefAppTheme;
	...
	public void onCreatePreferences(Bundle bundle, String s) {
        ...
        prefAppTheme = pm.findPreference("pref_theme");
		prefAppTheme.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
			@Override
			public boolean onPreferenceChange(Preference preference, Object newValue) {
				if(prefAppTheme.isChecked()) {
					editor.putString("AppTheme","LightTheme");
					AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO);
					prefAppTheme.setChecked(false);
					editor.commit();
				}
				else {
					editor.putString("AppTheme","DarkTheme");
					AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_YES);
					prefAppTheme.setChecked(true);
					editor.commit();
				}
				return false;
			}
